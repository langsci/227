...
\exi{\fts{(i)}} \il{Lithuanian}
\begin{xlist}
\exi{\fts{a.}}[]{\label{ex:sereikaite:i} \footnotesize
\gll Trūksta greta nuostabių-\textbf{jų} ir gražių-\textbf{jų} atstovių\\ 
\fts{lack.\textsc{prs.3}} \fts{near} \fts{wonderful.\textsc{gen.f.pl}-{\textsc{def}}} \fts{and} \fts{beautiful.\textsc{gen.f.pl}-{\textsc{def}}} \fts{representatives.\textsc{gen.f.pl}}\\
\trans \normalfont `The wonderful and beautiful representatives are missing.' \citep[adapted from][226]{Stolz2008}} 

\exi{\fts{b.}}[\fts{*}]{\label{ex:sereikaite:ii} \footnotesize
\gll Trūksta greta nuostabių-\textbf{jų} gražių-\textbf{jų} atstovių\\
\fts{lack.\textsc{prs.3}} \fts{near} \fts{wonderful.\textsc{gen.f.pl}-{\textsc{def}}} \fts{beautiful.\textsc{gen.f.pl}-{\textsc{def}}} \fts{representatives.\textsc{gen.f.pl}}\\
\trans \normalfont `The wonderful and beautiful representatives are missing.' \citep[adapted from][226]{Stolz2008}} 
\end{xlist} 
\end{exe}} unlike for example \ili{Greek} (see \citet{Alexiadou2014} and references therein) which is known for multiple \is{definiteness marking}marking of definiteness \REF{ex:sereikaite:10}.
