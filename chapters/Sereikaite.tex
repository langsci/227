...
\trans \normalfont `The wonderful and beautiful representatives are missing.' \citep[adapted from][226]{Stolz2008}}
\z 
\z} unlike for example \ili{Greek} (see \citet{Alexiadou2014} and references therein) which is known for multiple \is{definiteness marking}marking of definiteness \REF{ex:sereikaite:10}.
