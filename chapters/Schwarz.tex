...
notion(s) of \isi{definiteness} developed on the basis of familiar languages
...
between weak and strong \is{familiarity|)}familiarity, see][]{Roberts2003}. This needs to be further extended, however, to deal with
...
focused on \ili{German} and \ili{Germanic dialects}.\footnote{Parts of this section are adapted from \citet{Schwarz2013}.} The first
detailed discussion of \ili{Germanic dialects} with two forms for definite articles that I am aware of dates back to
...
\citep{Ebert1971,Ebert1971b}.\footnote{\citet{Leu2008} discusses
  related matters in \il{Swiss German}Swiss German, though he focuses
...
\begin{table}[h]
	\begin{tabularx}{.5\textwidth}{lXXXX} 
		...
		\lspbottomrule
	\end{tabularx}
	\caption{The definite article paradigms in \ili{Fering} \citep[159]{Ebert1971b}}
	\label{tab:schwarz:1}
\end{table}
...
\langinfo{German}{}{\citealt{Schwarz2009}}
\begin{xlist}
...
called \isi{bridging} uses \citep{Clark1975,Hawkins1978,Prince1981} involve
...
\isi{domain restriction} relative to which \isi{uniqueness} holds. (It also
...
\isi{relative clauses}. It has commonly been claimed in the literature that \isi{restrictive relative clauses} require the strong article in their
...
simple generalization about \isi{restrictive relative clauses} by
...
in  Akan\il{Akan} \citep{ArkohMatthewson2013},
 ...
 \ili{Ngamo} (Grubic 2016), American Sign Language\il{American Sign Language} \citep{IraniSchwarz2016}
...
Similarly, \ili{Mauritian Creole}, discussed by \citet{Wespel2008}, distinguishes between a \is{null determiners}null form \REF{ex:schwarz:16a} and one clearly derived
...
\ili{Lithuanian} \citep{SereikaiteToAppear}. It exhibits a definite suffix that
...
\citep{SereikaiteToAppear}, and ASL\il{American Sign Language} \citep{Koulidobrova2012,Irani2017}
...
definites for it. In contrast, according to intuitions reported by Anton Ingason\ia{Ingason, Anton} (\pc), \ili{Icelandic} would keep using the form corresponding
...
overt strong article, whereas \ili{German} prefers the weak article form.\footnote{\ili{Mauritian Creole} may be similar to Akan\il{Akan} in this regard; see \citet[189--190]{Wespel2008}.}
...
\REF{ex:schwarz:25}, which, as Wespel spell out in some detail, does not involve
a possessive construction of any sort.



\begin{exe}
\ex\label{ex:schwarz:25} \ili{Haitian Creole} \citep{Wespel2008}\\
\textit{papa Mari}\\
`the father of Mary' 
\end{exe}
...
apparently very different ways.\footnote{Another interesting potential
  ...
  variation in the type of \isi{definiteness} involved with \isi{bare noun
...
given \is{noun phrases}noun phrase (e.g. in terms of the \textit{de re} / \textit{de dicto}
...
\ex Scale of Uniqueness\\
      ...
      nouns/functional nouns $<$ \isi{proper names} $<$ personal pronouns \citep[314; adapted from L\"obner 2011]{Ortmann2014}
\end{exe}
...
more conclusive assessment of the semantic typology of \isi{definiteness}
